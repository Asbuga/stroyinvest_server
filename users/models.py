...
class Position(models.Model):
    ...
    department = models.ForeignKey(Department, on_delete=models.PROTECT, verbose_name='Найменування відділу')
    description = models.TextField(max_length=500, blank=True, null=True, verbose_name='Короткий опис посади')
    create_at = models.DateTimeField(default=now, verbose_name='Дата створення')
...
class Employee(models.Model):
    ...
    department = models.ForeignKey(Department, on_delete=models.CASCADE, verbose_name='Відділ')
